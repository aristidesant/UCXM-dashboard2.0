...
interface EmotionCallsViewProps {
...
const SENTIMENT_LEVELS = [
  {
    label: 'Llamadas Muy Negativas',
    color: '#FF4D4F',
    key: 'veryNegative',
  },
  {
    label: 'Llamadas Negativas',
    color: '#FFC53D',
    key: 'negative',
  },
  {
    label: 'Llamadas Neutral',
    color: '#8C8C8C',
    key: 'neutral',
  },
  {
    label: 'Llamadas Positivas',
    color: '#52C41A',
    key: 'positive',
  },
  {
    label: 'Llamadas Muy Positivas',
    color: '#1BB54A',
    key: 'veryPositive',
  },
];

export const EmotionCallsView: React.FC<EmotionCallsViewProps> = ({
  veryNegativeCount,
  negativeCount,
  neutralCount,
  positiveCount,
